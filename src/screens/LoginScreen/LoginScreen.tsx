...
export const LoginScreen = () => {
  ...
  const {colors, setIsAuth, isAuth} = useContext(AuthContext);
          ...
          <View style={styles.form}>
            <View style={styles.formRow}>
              <View style={{marginBottom: 6, alignSelf: 'flex-start'}}>
                <Text style={{color: colors.text}}>Почта</Text>
              </View>
            ...
            <View style={styles.formRow}>
              <View style={{marginBottom: 6, alignSelf: 'flex-start'}}>
                <Text style={{color: colors.text}}>Пароль</Text>
              </View>
              <TextInput
                style={styles.input}
            ...
            <View style={styles.submitRow}>
              <View>
                <Text numberOfLines={2} style={{color: colors.error}}>
                  {errorText}
                </Text>
              </View>
